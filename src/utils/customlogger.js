...
class Logger {
	...
	info(text) {
		console.log(
			`${chalk.magenta(this.date)}${chalk.gray(` - `)}${chalk.blue("[")}${chalk.cyanBright(`${this.name}`)}${chalk.blue("]")} ${chalk.greenBright(text)}`
		);
	}

	warn(text) {
		console.log(
			`${chalk.magenta(this.date)}${chalk.gray(` - `)}${chalk.blue("[")}${chalk.cyanBright(`${this.name}`)}${chalk.blue("]")}  ${chalk.yellowBright(text)}`
		);
	}

	error(text) {
		console.log(
			`${chalk.magenta(this.date)}${chalk.gray(` - `)}${chalk.blue("[")}${chalk.cyanBright(`${this.name}`)}${chalk.blue("]")}  ${chalk.redBright(text)}`
		);
	}
}
